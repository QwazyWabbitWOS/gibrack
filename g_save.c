...
void InitGame(void)
{
	...
	// change anytime vars
	gibflags = gi.cvar("gibflags", "0", CVAR_SERVERINFO);
	dmflags = gi.cvar("dmflags", "0", CVAR_SERVERINFO);
	foxhunt_penalty = gi.cvar("foxhunt_penalty", "10", CVAR_SERVERINFO);
	bullets_gib = gi.cvar("bullets_gib", "8", CVAR_SERVERINFO);
	fraglimit = gi.cvar("fraglimit", "0", CVAR_SERVERINFO);
	timelimit = gi.cvar("timelimit", "0", CVAR_SERVERINFO);
	team = gi.cvar("team", "", CVAR_USERINFO);

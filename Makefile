...
#
# Edited April 24, 2026 by QwazyWabbit
#
...
GAME_SRCS = \
	...
	m_mutant.c m_parasite.c m_soldier.c m_supertank.c m_tank.c p_cam.c \
	p_client.c p_hud.c p_view.c p_weapon.c q_shared.c

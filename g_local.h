...
// SLUGFILLER--default delay between pain anims
#define	PAINTIME		0.2
...
#define AI_DODGING				0x00008000
#define AI_DODGE_MUST			0x00010000
#define AI_SLIDING				0x00020000

// SLUGFILLER--monster animations
#define	MANIM_STAND		0
#define	MANIM_WALK		1
#define	MANIM_RUN		2
#define MANIM_DUCK		3
#define MANIM_MISC		4
#define	MANIM_MELEE		5
#define	MANIM_MISSILE	6
#define	MANIM_DEATH		7
...
typedef struct
{
	...
	int			bloody_que;			// blood overflaw control
...
typedef struct
{
	...
	void		(*dodge)(edict_t* self, edict_t* inflictor, edict_t* attacker, float eta, trace_t* tr, qboolean must);
	void		(*attack)(edict_t* self);
	void		(*melee)(edict_t* self);
	void		(*sight)(edict_t* self, edict_t* other);
	void		(*duck)(edict_t* self, edict_t* other, float eta);
...
#define MOD_LAVA			18
#define MOD_CRUSH			19
#define MOD_TELEFRAG		20
#define MOD_FALLING			21
#define MOD_SUICIDE			22
#define MOD_EXPLOSIVE		23
#define MOD_BARREL			24
#define MOD_BOMB			25
#define MOD_EXIT			26
#define MOD_SPLASH			27
#define MOD_TARGET_LASER	28
#define MOD_TRIGGER_HURT	29
#define MOD_HIT				30
#define MOD_TARGET_BLASTER	31
...
extern	cvar_t* coop;
extern	cvar_t* gibflags;
extern	cvar_t* dmflags;
extern	cvar_t* foxhunt_penalty;
extern	cvar_t* lives;
extern	cvar_t* bullets_gib;
extern	cvar_t* skill;
...
#if defined _WIN32
//
// A noreturn wrapper for gi.error
//
...
#define DAMAGE_NO_BLOOD			0x00000040  // SLUGFILLER--no blood or sparks

#define DEFAULT_BULLET_HSPREAD	300
#define DEFAULT_BULLET_VSPREAD	500
#define DEFAULT_SHOTGUN_HSPREAD	500
...
void ThrowBlood(vec3_t origin, vec3_t normal);
...
qboolean M_CheckMove(edict_t* ent, float yaw, float dist);
void M_MoveToGoal(edict_t* ent, float dist);
void M_ChangeAngles(edict_t* ent);
...
typedef struct
{
	...
	int			exitframe;			// level.framenum the client exited the game
	int			score;				// frags, etc
	...
	qboolean	goagain;			// SLUGFILLER--had an extra life
	qboolean	spectator;			// client is a spectator
} client_respawn_t;
